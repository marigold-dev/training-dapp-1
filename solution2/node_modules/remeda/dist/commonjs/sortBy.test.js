...
describe('data first', function () {
    ...
    test('sort booleans correctly', function () {
        expect(sortBy_1.sortBy(objects, [function (x) { return x.active; }, 'desc']).map(function (x) { return x.active; })).toEqual([true, true, false, false]);
    });
    test('sort dates correctly', function () {
        expect(sortBy_1.sortBy(objects, [function (x) { return x.date; }, 'desc']).map(function (x) { return x.id; })).toEqual([4, 3, 2, 1]);
    });
    test('sort objects correctly', function () {
        expect(sortBy_1.sortBy(objects, function (x) { return x.weight; }, function (x) { return x.color; }).map(function (x) { return x.weight; })).toEqual([1, 1, 2, 3]);
    });
    test('sort objects correctly mixing sort pair and sort projection', function () {
        expect(sortBy_1.sortBy(objects, function (x) { return x.weight; }, [function (x) { return x.color; }, 'asc']).map(function (x) { return x.weight; })).toEqual([1, 1, 2, 3]);
    });
    test('sort objects descending correctly', function () {
        expect(sortBy_1.sortBy(objects, [function (x) { return x.weight; }, 'desc']).map(function (x) { return x.weight; })).toEqual([
            3, 2, 1, 1,
        ]);
    });
});
describe('data last', function () {
    ...
    test('sort objects correctly', function () {
        var sortFn = sortBy_1.sortBy(function (x) { return x.weight; }, function (x) { return x.color; });
    ...
    test('sort objects correctly by weight asc then color desc', function () {
        expect(sortBy_1.sortBy([function (x) { return x.weight; }, 'asc'], [function (x) { return x.color; }, 'desc'])(objects).map(function (x) { return x.color; })).toEqual(['purple', 'green', 'red', 'blue']);
    });
});
